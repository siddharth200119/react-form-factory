...
function FormBuilder(props) {
  ...
  (0, _react.useEffect)(function () {
    Object.keys(defaultStyles).forEach(function (key) {
      if (styles.key !== undefined) {
        document.documentElement.style.setProperty("--".concat(key), styles[key]);
      } else {
        document.documentElement.style.setProperty("--".concat(key), defaultStyles[key]);
      }
    });
  });
  ...
  var handleSubmit = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var valid, newFormFields, formData, response, result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            valid = true;
            newFormFields = formFields.map(function (field) {
              var error = false;
              var errorMessage = "";
              ...
              if (field.min && field.value.length < field.min) {
                error = true;
                errorMessage = "Minimum value is ".concat(field.min, ".");
              }

              // Maximum length validation
              if (field.max && field.value.length > field.max) {
                error = true;
                errorMessage = "Maximum value is ".concat(field.max, ".");
              }

              // Step size validation
              if (field.step && field.value % field.step !== 0) {
                error = true;
                errorMessage = "Value must be a multiple of ".concat(field.step, ".");
              }
              ...
              if (field.maxChecked && Array.isArray(field.value) && field.value.length > field.maxChecked) {
                error = true;
                errorMessage = "You can select up to ".concat(field.maxChecked, " options.");
              }
              ...
              if (field.minChecked && Array.isArray(field.value) && field.value.length < field.minChecked) {
                error = true;
                errorMessage = "You must select at least ".concat(field.minChecked, " options.");
              }
            ...
            formData = newFormFields.reduce(function (acc, field) {
